...
public class MusicPlayer extends AppCompatActivity implements View.OnClickListener, SeekBar.OnSeekBarChangeListener{
    ...
    Button last,next,play,pause,addmylove,backlove;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new MySQLiteOpenHelper(MusicPlayer.this, DB_NAME, null, VERSION);
        dbHelper.getWritableDatabase();
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_music_player);
        name = findViewById(R.id.name);
        backlove = findViewById(R.id.back_list);
        ...
        addmylove = findViewById(R.id.add_mylove);
        addmylove.setOnClickListener(this);
        //绑定按钮
        ...
        backlove.setOnClickListener(this);
        ...
        length_music = intent.getIntExtra("length",0) - 1;
        ...
        switch (v.getId()){
            case R.id.last://播放上一首
                ...
                if(position > 0)
                {
                    ...
                    intent.putExtra("length",length_music);
            ...
            case R.id.pause:
                ...
                break;
            case R.id.add_mylove:
                String rtitle = musicname;
                String rauthor = artistname;
                String rurl = url;
                Music addMusicLove = new Music(rtitle,rauthor,rurl);
                SQLiteDatabase db = dbHelper.getWritableDatabase();
                boolean isLoved = mySQLiteOpenHelper.isLove(addMusicLove);
                if(isLoved){
                    mySQLiteOpenHelper.deleteMyLove(addMusicLove);
                    Toast.makeText(this, "取消收藏成功", Toast.LENGTH_SHORT).show();
                }
                else{
                    long r1 = mySQLiteOpenHelper.addMyLove(addMusicLove);
                    if(r1!=-1){
                ...
                case R.id.back_list:
                    Intent intent = new Intent(MusicPlayer.this,MyLove.class);
                    startActivity(intent);
                    if(mediaPlayer.isPlaying()){
                        mediaPlayer.pause();
                    }
